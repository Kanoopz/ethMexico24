...
export interface DataFeedServerInterface extends Interface {
    getFunction(nameOrSignature: "containsBytecode" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "multicall" | "tryMulticall" | "updateBeaconSetWithBeacons"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "UpdatedBeaconSetWithBeacons" | "UpdatedBeaconWithSignedData"): EventFragment;
...
export interface DataFeedServer extends BaseContract {
    connect(runner?: ContractRunner | null): DataFeedServer;
    waitForDeployment(): Promise<this>;
    interface: DataFeedServerInterface;
...
//# sourceMappingURL=DataFeedServer.d.ts.map