...
export interface OevDataFeedServerInterface extends Interface {
    getFunction(nameOrSignature: "containsBytecode" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "multicall" | "oevProxyToBalance" | "tryMulticall" | "updateBeaconSetWithBeacons" | "updateOevProxyDataFeedWithSignedData" | "withdraw"): FunctionFragment;
    getEvent(nameOrSignatureOrTopic: "UpdatedBeaconSetWithBeacons" | "UpdatedBeaconWithSignedData" | "UpdatedOevProxyBeaconSetWithSignedData" | "UpdatedOevProxyBeaconWithSignedData" | "Withdrew"): EventFragment;
...
export interface OevDataFeedServer extends BaseContract {
    connect(runner?: ContractRunner | null): OevDataFeedServer;
    waitForDeployment(): Promise<this>;
    interface: OevDataFeedServerInterface;
    ...
    oevProxyToBalance: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
    ...
    getFunction(nameOrSignature: "oevProxyToBalance"): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
...
//# sourceMappingURL=OevDataFeedServer.d.ts.map