...
export interface IBeaconUpdatesWithSignedDataInterface extends Interface {
    getFunction(nameOrSignature: "containsBytecode" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "multicall" | "tryMulticall" | "updateBeaconSetWithBeacons" | "updateBeaconWithSignedData"): FunctionFragment;
...
export interface IBeaconUpdatesWithSignedData extends BaseContract {
    connect(runner?: ContractRunner | null): IBeaconUpdatesWithSignedData;
...
//# sourceMappingURL=IBeaconUpdatesWithSignedData.d.ts.map