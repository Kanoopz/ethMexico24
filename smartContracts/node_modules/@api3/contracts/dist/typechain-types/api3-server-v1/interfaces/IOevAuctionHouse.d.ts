...
export interface IOevAuctionHouseInterface extends Interface {
...
export interface IOevAuctionHouse extends BaseContract {
    connect(runner?: ContractRunner | null): IOevAuctionHouse;
    waitForDeployment(): Promise<this>;
    interface: IOevAuctionHouseInterface;
    ...
    AUCTIONEER_ROLE_DESCRIPTION: TypedContractMethod<[], [string], "nonpayable">;
    FULFILLMENT_REPORTING_PERIOD: TypedContractMethod<[], [bigint], "nonpayable">;
    MAXIMUM_AUCTIONEER_DATA_LENGTH: TypedContractMethod<[
    ], [
        bigint
    ], "nonpayable">;
    MAXIMUM_BIDDER_DATA_LENGTH: TypedContractMethod<[], [bigint], "nonpayable">;
    MAXIMUM_BID_LIFETIME: TypedContractMethod<[], [bigint], "nonpayable">;
    MINIMUM_BID_LIFETIME: TypedContractMethod<[], [bigint], "nonpayable">;
    PROXY_SETTER_ROLE_DESCRIPTION: TypedContractMethod<[
    ], [
        string
    ], "nonpayable">;
    WITHDRAWAL_WAITING_PERIOD: TypedContractMethod<[], [bigint], "nonpayable">;
    WITHDRAWER_ROLE_DESCRIPTION: TypedContractMethod<[], [string], "nonpayable">;
    accessControlRegistry: TypedContractMethod<[], [string], "view">;
    accumulatedProtocolFees: TypedContractMethod<[], [bigint], "nonpayable">;
    accumulatedSlashedCollateral: TypedContractMethod<[], [bigint], "nonpayable">;
    adminRole: TypedContractMethod<[], [string], "view">;
    adminRoleDescription: TypedContractMethod<[], [string], "view">;
    auctioneerRole: TypedContractMethod<[], [string], "nonpayable">;
    ...
    bidderToBalance: TypedContractMethod<[
        bidder: AddressLike
    ], [
        bigint
    ], "nonpayable">;
    ...
    collateralInBasisPoints: TypedContractMethod<[], [bigint], "nonpayable">;
    collateralRateProxy: TypedContractMethod<[], [string], "nonpayable">;
    ...
    protocolFeeInBasisPoints: TypedContractMethod<[], [bigint], "nonpayable">;
    proxySetterRole: TypedContractMethod<[], [string], "nonpayable">;
    ...
    withdrawerRole: TypedContractMethod<[], [string], "nonpayable">;
    getFunction<T extends ContractMethod = ContractMethod>(key: string | FunctionFragment): T;
    getFunction(nameOrSignature: "AUCTIONEER_ROLE_DESCRIPTION"): TypedContractMethod<[], [string], "nonpayable">;
    getFunction(nameOrSignature: "FULFILLMENT_REPORTING_PERIOD"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "MAXIMUM_AUCTIONEER_DATA_LENGTH"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "MAXIMUM_BIDDER_DATA_LENGTH"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "MAXIMUM_BID_LIFETIME"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "MINIMUM_BID_LIFETIME"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "PROXY_SETTER_ROLE_DESCRIPTION"): TypedContractMethod<[], [string], "nonpayable">;
    getFunction(nameOrSignature: "WITHDRAWAL_WAITING_PERIOD"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "WITHDRAWER_ROLE_DESCRIPTION"): TypedContractMethod<[], [string], "nonpayable">;
    getFunction(nameOrSignature: "accessControlRegistry"): TypedContractMethod<[], [string], "view">;
    getFunction(nameOrSignature: "accumulatedProtocolFees"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "accumulatedSlashedCollateral"): TypedContractMethod<[], [bigint], "nonpayable">;
    ...
    getFunction(nameOrSignature: "auctioneerRole"): TypedContractMethod<[], [string], "nonpayable">;
    ...
    getFunction(nameOrSignature: "bidderToBalance"): TypedContractMethod<[bidder: AddressLike], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "bidderToEarliestWithdrawalTimestamp"): TypedContractMethod<[bidder: AddressLike], [bigint], "nonpayable">;
    ...
    getFunction(nameOrSignature: "chainIdToNativeCurrencyRateProxy"): TypedContractMethod<[chainId: BigNumberish], [string], "nonpayable">;
    getFunction(nameOrSignature: "collateralInBasisPoints"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "collateralRateProxy"): TypedContractMethod<[], [string], "nonpayable">;
    ...
    getFunction(nameOrSignature: "protocolFeeInBasisPoints"): TypedContractMethod<[], [bigint], "nonpayable">;
    getFunction(nameOrSignature: "proxySetterRole"): TypedContractMethod<[], [string], "nonpayable">;
    ...
    getFunction(nameOrSignature: "withdrawerRole"): TypedContractMethod<[], [string], "nonpayable">;
...
//# sourceMappingURL=IOevAuctionHouse.d.ts.map