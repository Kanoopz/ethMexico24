...
export interface IDataFeedProxyInterface extends Interface {
    getFunction(nameOrSignature: "api3ServerV1" | "dataFeedId" | "read"): FunctionFragment;
...
export interface IDataFeedProxy extends BaseContract {
    connect(runner?: ContractRunner | null): IDataFeedProxy;
...
//# sourceMappingURL=IDataFeedProxy.d.ts.map