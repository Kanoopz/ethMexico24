...
export interface IAccessControlRegistryInterface extends Interface {
    getFunction(nameOrSignature: "getRoleAdmin" | "grantRole" | "hasRole" | "initializeManager" | "initializeRoleAndGrantToSender" | "multicall" | "renounceRole" | "revokeRole" | "tryMulticall"): FunctionFragment;
...
export interface IAccessControlRegistry extends BaseContract {
    connect(runner?: ContractRunner | null): IAccessControlRegistry;
