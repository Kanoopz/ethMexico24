...
export interface MockApi3ServerV1Interface extends Interface {
    ...
    encodeFunctionData(functionFragment: "mockUpdate", values: [BytesLike, BigNumberish, BigNumberish]): string;
    ...
    decodeFunctionResult(functionFragment: "mockUpdate", data: BytesLike): Result;
...
export interface MockApi3ServerV1 extends BaseContract {
    connect(runner?: ContractRunner | null): MockApi3ServerV1;
    waitForDeployment(): Promise<this>;
    interface: MockApi3ServerV1Interface;
    ...
    mockUpdate: TypedContractMethod<[
        dataFeedId: BytesLike,
        value: BigNumberish,
        timestamp: BigNumberish
    ], [
    ...
    getFunction(nameOrSignature: "mockUpdate"): TypedContractMethod<[
        dataFeedId: BytesLike,
        value: BigNumberish,
        timestamp: BigNumberish
    ], [
...
//# sourceMappingURL=MockApi3ServerV1.d.ts.map